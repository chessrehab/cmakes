...
void dump(const unsigned char *, const unsigned int,const unsigned int);
...
struct ip_hdr {
	unsigned char ip_version_and_header_length;	//1 BYTE vearsion and header length (2 values in one byte)
